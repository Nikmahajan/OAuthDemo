...
export const fetchGoogleAccessTokenCode = (code) => {
  try {
    ...
    const body = `grant_type=authorization_code&code=${code}&redirect_uri=${encodeURIComponent(returnUrl)}&client_secret=ZDznUoDsolSgbPKgn3Rwy8DN&client_id=101163496378-g4rommimqt55a1m6om01aotp2c3tajkj.apps.googleusercontent.com`;
    return formPOST({ url, headers, body });
  } catch (e) {
    console.log(e);
  }
