...
export const sendESignatureAction = (url, users) => ({
  type: 'SEND_E_SIGNATURE',
  url,
  users,
});

export const sendESignatureSuccess = resp => ({
  type: 'SEND_E_SIGNATURE_SUCCESS',
  resp,
});

export const sendReminderAction = (user) => ({
  type: 'SEND_REMINDER',
  user,
});

export const sendReminderSuccess = resp => ({
  type: 'SEND_REMINDER_SUCCESS',
  resp,
});

export const emptySignaturesAction = () => ({
  type: 'EMPTY_SIGNATURES',
});

export const fetchSignatureStatusAction = () => ({
  type: 'FETCH_SIGNATURE_STATUS',
});

export const fetchSignatureStatusSuccess = signatures => ({
